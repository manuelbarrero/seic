...
<body>
  ...
  <table width="100%" style="margin-top: 40px;">
    <tr>
        ...
        <td class="text-right" style="font-size: 18px; vertical-align: top;"> 
         <!-- Presupuesto -->Factura No.: <span style="color: red; font-size: 18px;">00{{ $invoice->id }}</span><br>
  ...
  <table class="table-bordered" width="100%">
    ...
    <tr>
        <td colspan="" class="text-right">IVA {{ $invoice->tax_rate }}%</td>
        <td class="text-right">{{ $invoice->tax_amount }}</td>
    </tr>
    <tr>
        <td colspan="" class="text-right font-16">Total</td>
  ...
  <table class="table-bordered">
    ...
    <tr>
        <td valign="top">
          <img src="{{asset('images/paypal.png')}}" width="150"/></td>
        <td>
        Nombre: Miguel Barrero<br>
        Email: miguel@interdatos.net
        </td>
    ...
    <tr>
        <td valign="top">
          <img src="{{asset('images/bod.png')}}" width="150"/>
        </td>
        <td>
        B.O.D. Cuenta Nº 01160127870005006252<br>
        Titular: INTERDATOS, C.A.<br>
        RIF: J-30993349-3<br>
        </td>
    </tr>
